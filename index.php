    ...
    switch ($action) {
        case 'history':
            ...
            <ul>
                ...
                ?>
                <li>(<a href="index.php?title=Special:old&page=<?php echo htmlspecialchars(urlencode($originalPageName)); ?>&revision=<?php echo $r->id; ?>">archive</a>) <?php echo formatDate($r->time); ?> by <?php echo htmlspecialchars($authorinfo->username); ?> (<?php echo htmlspecialchars($r->summary); ?>)</li>
                <?php } ?>
            </ul>
            <?php
            break;
